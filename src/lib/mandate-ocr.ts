...
import {
  ...
  hasGoogleWorkloadIdentity,
} from "@/lib/google-workload-identity";
...
function documentAiConfig() {
  ...
  if (!audience || !processorId || !projectId || !hasGoogleWorkloadIdentity())
    return null;
  return { processorId, location, projectId };
}
